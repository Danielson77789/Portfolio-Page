  ...
  return (
    <div className='projects-body'>
      ...
      <div className='projects-container'>
          ...
          <div className='card-four'>
              <CustomProjectCard img={bloomFlip} side="right" title="Simple Neural Network" projectType="C Cuda Development" description="This project was a final for a GPU Computing class where we learned to use cuda framework in C to utilize the GPU computation 
          ...
          <div className='card-four'>
              <CustomProjectCard img={towerDefence} side="left" title="Tower Defense" projectType="Unity Game Development" description="In this unity project that me and my team had put together for are software architecture class I learned processes that involve
